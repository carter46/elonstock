...
<div class="trading-card p-8">
<h1 class="text-3xl font-bold mb-6 flex items-center gap-3 text-white">
<span class="material-icons text-primary-container">forum</span>
Live Chat — <?php echo htmlspecialchars($siteName); ?>
</h1>
<div class="rounded-xl bg-surface-container border border-white/5 p-6 mb-6">
<div class="flex items-center gap-3 mb-4">
<span class="w-3 h-3 rounded-full bg-success animate-pulse"></span>
<span class="font-semibold text-on-surface">Support agents are online</span>
</div>
...
<p class="text-sm text-on-surface-variant text-center">
                Need immediate assistance? <a href="mailto:<?php echo htmlspecialchars(get_site_setting('contact_email', 'support@example.com')); ?>" class="text-primary-container font-semibold hover:underline">Email us</a> or call our support line.
            </p>
</div>
</div>
</main>
