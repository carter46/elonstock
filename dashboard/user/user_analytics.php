...
<span class="text-xs font-bold text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-full"><?php if ($profitGrowthPct > 0): ?>+<?php echo number_format($profitGrowthPct, 1); ?>%<?php endif; ?></span>
</div>
...
<span class="text-xs font-bold text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-full"><?php if ($dailyYieldPct > 0): ?><?php echo number_format($dailyYieldPct, 2); ?>% / day<?php endif; ?></span>
</div>
...
<span class="text-xs font-bold text-slate-400 bg-slate-100 dark:bg-zinc-800 px-2 py-1 rounded-full"><?php echo count($activePlans) > 0 ? 'Stable' : 'No plans'; ?></span>
</div>
...
<button type="button" data-period="1D" class="analytics-filter-btn px-3 py-1 text-xs font-semibold rounded hover:bg-white dark:hover:bg-zinc-700 transition-all<?php echo $period === '1D' ? ' is-active' : ''; ?>">1D</button>
<button type="button" data-period="1W" class="analytics-filter-btn px-3 py-1 text-xs font-semibold rounded hover:bg-white dark:hover:bg-zinc-700 transition-all<?php echo $period === '1W' ? ' is-active' : ''; ?>">1W</button>
<button type="button" data-period="1M" class="analytics-filter-btn px-3 py-1 text-xs font-semibold rounded hover:bg-white dark:hover:bg-zinc-700 transition-all<?php echo $period === '1M' ? ' is-active' : ''; ?>">1M</button>
<button type="button" data-period="1Y" class="analytics-filter-btn px-3 py-1 text-xs font-semibold rounded hover:bg-white dark:hover:bg-zinc-700 transition-all<?php echo $period === '1Y' ? ' is-active' : ''; ?>">1Y</button>
<button type="button" data-period="ALL" class="analytics-filter-btn px-3 py-1 text-xs font-semibold rounded hover:bg-white dark:hover:bg-zinc-700 transition-all<?php echo $period === 'ALL' ? ' is-active' : ''; ?>">ALL</button>
</div>
</div>
