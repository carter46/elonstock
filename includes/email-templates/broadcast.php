...
<a href="<?= htmlspecialchars($site_url) ?>/dashboard" style="display:inline-block;padding:14px 28px;background:#4b8eff;color:#ffffff;font-weight:700;text-decoration:none;border-radius:8px">Access Your Dashboard</a>
</p>
</div>
