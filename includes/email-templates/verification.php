...
<span style="display:inline-block;padding:6px 12px;background:rgba(75,142,255,0.15);color:#005bc1;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;border-radius:9999px;margin-bottom:20px">Account Verification</span>
...
<a href="<?= htmlspecialchars($verify_url) ?>" style="display:inline-block;padding:16px 32px;background:#4b8eff;color:#ffffff;font-weight:700;font-size:16px;border-radius:8px;text-decoration:none;box-shadow:0 4px 14px rgba(75,142,255,0.35)">Verify Email →</a>
</div>
