...
<div style="width:48px;height:48px;background:rgba(75,142,255,0.15);border-radius:8px;display:flex;align-items:center;justify-content:center;margin-bottom:24px">
...
<a href="<?= htmlspecialchars($reset_url) ?>" style="display:inline-block;padding:14px 28px;background:#4b8eff;color:#ffffff;font-weight:700;font-size:16px;border-radius:8px;text-decoration:none;box-shadow:0 4px 14px rgba(75,142,255,0.25)">Reset My Password →</a>
</div>
