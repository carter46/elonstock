...
<span style="display:inline-block;padding:6px 12px;background:rgba(75,142,255,0.15);color:#005bc1;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;border-radius:9999px;margin-bottom:20px">Contact Form</span>
...
<tr><td style="padding:8px 0;color:#5a6578;font-weight:600">Email</td><td style="padding:8px 0"><a href="mailto:<?= htmlspecialchars($email) ?>" style="color:#4b8eff"><?= htmlspecialchars($email) ?></a></td></tr>
...
<div style="padding:16px;background:#e8eef6;border-radius:8px;border-left:4px solid #4b8eff">
