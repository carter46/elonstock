...
<span style="display:inline-block;padding:6px 12px;background:rgba(196,30,10,0.15);color:#c41e0a;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;border-radius:9999px;margin-bottom:20px">Welcome</span>
...
<a href="<?= htmlspecialchars($site_url) ?>" style="display:inline-block;padding:16px 32px;background:linear-gradient(135deg,#ff5c1a 0%,#c41e0a 55%,#8b0000 100%);background-color:#c41e0a;color:#ffffff;font-weight:700;font-size:16px;border-radius:8px;text-decoration:none;box-shadow:0 4px 14px rgba(196,30,10,0.35)">Visit <?= htmlspecialchars($siteName) ?> →</a>
</div>
