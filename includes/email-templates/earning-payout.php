<?php
/**
 * Stock Wealth - Earning Payout Email Template
 */
$config = $config ?? [];
$site_url = $site_url ?? '/';
...
<h2 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#081422;line-height:1.3">Your earnings have been credited</h2>
<p style="margin:0 0 16px;color:#5a6578;font-size:16px">Hi <strong style="color:#081422"><?= htmlspecialchars($name) ?></strong>,</p>
<p style="margin:0 0 24px;color:#5a6578;font-size:16px">Great news! Your investment earnings have been calculated and credited to your account.</p>
<div style="margin:24px 0;padding:20px;background:#eef2f8;border-radius:8px;border-left:4px solid #16a34a">
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
<span style="color:#5a6578;font-size:14px;font-weight:600">Earnings Credited:</span>
...
<span style="color:#5a6578;font-size:12px">From Plan:</span>
<span style="color:#081422;font-size:14px;font-weight:600"><?= htmlspecialchars($planName) ?></span>
</div>
</div>
<p style="margin:24px 0;color:#5a6578;font-size:16px">Your earnings have been automatically added to your wallet balance and are available for withdrawal or reinvestment.</p>
